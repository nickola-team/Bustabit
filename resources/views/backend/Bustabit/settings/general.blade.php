        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    @include('backend.White.settings.partials.auth', ['directories' => $directories])

                    </div>
                    <div class="col-md-6">
                    @include('backend.White.settings.partials.throttling')
                    @include('backend.White.settings.partials.registration')
                    </div>
                </div>
            </div>

<tr>
	<td><p class="text-sm font-weight-normal mb-0">{{$stat->category->trans_kr}}</p></td>
    <td><p class="text-sm font-weight-normal mb-0">{{get_gamename($stat->category->game_code, $stat->game, $stat->type)}}</p></td>
